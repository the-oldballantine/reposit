    ...
    var l = {
      ...
      o = {
        ...
        imagesLoaded: function (e) {
          async function t() {
            ++n === i && o.addEvent(e, "dmeImagesLoaded");
          }
          var a = e.getElementsByTagName("img") || document.images,
            i = a.length,
            n = 0;
          i < 1 && o.addEvent(e, "dmeImagesLoaded");
      ...
      t = {
        ...
        dmeSlider: function (e) {
          cnvs.dmeSlider && cnvs.dmeSlider.init(e || ".swiper_wrapper");
        },
                ...
                (function () {
                  ...
                  var a =
                    getComputedStyle(N.getVars.elHeader).getPropertyValue(
                      "--dme-primary-menu-submenu-display-speed"
                    ) || 666;
                  isNaN(a.split("ms")[0])
                ...
                (function () {
                  ...
                  0 <
                    ...
                    N.getVars.elHeader.classList.contains("floating-header") &&
                      ...
                      ).getPropertyValue("--dme-header-floating-padding")),
                      document
                        .querySelectorAll(
                          ".mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content"
                        )
              ...
              ((i = N.getVars.elHeader.classList.contains("no-sticky")
                ...
                : ("false" ==
                  N.getVars.elHeader.getAttribute("data-sticky-shrink")
                    ...
                    : getComputedStyle(N.getVars.elHeader).getPropertyValue(
                        "--dme-header-height-shrink"
                      )
                  ).split("px")[0]),
              t.style.setProperty(
                "--dme-page-submenu-sticky-offset",
                i + "px"
              ),
              setTimeout(function () {
        ...
        PageTransition: {
          init: function (e) {
            ...
            (d =
              ...
              (p = c
                ? "theme" == c
                  ? ' style="--dme-loader-color:var(--dme-themecolor);"'
                  : ' style="--dme-loader-color:' + c + ';"'
                : p) +
              ">" +
              (d = d || u) +
              "</div>"),
            ...
            N.isFuncTrue(function () {
              ...
              t.forEach(function (a) {
                var i = a.getAttribute("data-percent") || 90,
                  ...
                  e = Number(e) + "ms";
                n.style.setProperty("--dme-progress-speed", e),
                  new IntersectionObserver(
                    function (e, t) {
                      e.forEach(function (e) {
                        e.isIntersecting &&
                  ...
                  fetch(a)
                    ...
                    .then(function (e) {
                      ...
                      n.classList.remove("customjs"),
                        N.imagesLoaded(n),
                        n.addEventListener("dmeImagesLoaded", function () {
                      ...
                      (g = []),
                        e.forEach(function (e) {
                          ...
                          (d.elem = e),
                            ...
                            isNaN(c) ||
                              e.style.setProperty("--dme-parallax-ratio", c),
                            H(d),
                            g.push(d),
                            p.observe(e);
                        });
      ...
      (i = e),
        fastdom.measure(function () {
          ...
          a >= i.start && a <= i.end
            ...
            i.elem.style.setProperty("--dme-scroll-percent", n),
            i.elem.style.setProperty("--dme-scroll-ratio", r),
            i.elem.style.setProperty("--dme-scroll-start", s),
            i.elem.style.setProperty("--dme-scroll-end", o);
        });
    }
    function F() {
    ...
    function I(e, t = "word") {
      (e.innerHTML =
        ...
        e.querySelectorAll("span")?.forEach(function (e, t) {
          e.style.setProperty("--dme-split-index", t + 1);
        });
    }
